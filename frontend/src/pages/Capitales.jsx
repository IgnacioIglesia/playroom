    ...
    return (
      <div className="min-h-screen bg-gray-950 text-white flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-4">
          ...
          <p className="text-gray-400">Cargando países del mundo...</p>
        </div>
        <Footer />
      </div>
    )
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 py-16">
          <div className="w-full max-w-2xl">
            ...
            <div className="text-center mb-10">
              ...
              <h1 className="text-4xl font-extrabold mt-4">Adivina la Capital</h1>
      ...
      <div className="min-h-screen bg-gray-950 text-white flex flex-col">
        ...
        {confirmarSalida && (
            ...
            <div className="bg-gray-900 border border-gray-700 rounded-3xl p-8 max-w-sm w-full text-center flex flex-col gap-6">
              ...
              <div>
                ...
                <p className="text-gray-400 mt-2 text-sm">Perdés el progreso actual. Esta acción no se puede deshacer.</p>
              </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 py-8">
          ...
          <div className="w-full max-w-2xl">
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-3xl p-10 mb-4 text-center relative overflow-hidden">
